...
// Variables globales
let rows, columns, width, height, data, kakuroBoard, combinationsGlobalList=[];
    ...
    for (const hint of S) {
        ...
        if (valorPistaFila !== 0) {
            ...
            */
            ...
            if(newCombinationsRow.length !== 0){
            combinationsGlobalList.push([[row, column], newCombinationsRow])
            console.log("Combinaciones globales: " + combinationsGlobalList)
            }else{
                combinationsGlobalList.push([[row, column], combinationsRow])
            }
        ...
        if (valorPistaColumna !== 0) {
            ...
            */
            ...
            if(newCombinationsColumn.length !== 0){
            combinationsGlobalList.push([[row, column], newCombinationsColumn])
            console.log("Combinaciones globales: " + combinationsGlobalList)
            }else{
                combinationsGlobalList.push([[row, column], combinationsColumn])
            }
        }

    }
    sortByShortestCombination()
    console.log("Combinaciones globales ordenadas:")
    for (const combination of combinationsGlobalList) {
        console.log(combination.join(', '));
    }
    return false; // Si no se repiten números en ninguna pista, devolver falso
}
...
function sortByShortestCombination() {
    // Custom sorting function
    function compareByLength(a, b) {
        const totalLengthA = a[1].flat().length;
        const totalLengthB = b[1].flat().length;
    ...
    // Sort the combinations array using the custom sorting function
    combinationsGlobalList.sort(compareByLength);
